...
class AlertAPITester:
    def __init__(self, base_url: str = "https://forecast-weights.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing backend at: https://forecast-weights.preview.emergentagent.com")
