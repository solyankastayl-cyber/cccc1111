...
class AlertAPITester:
    def __init__(self, base_url: str = "https://fractal-interface-v2.preview.emergentagent.com"):
...
def main():
    ...
    print(f"Testing backend at: https://fractal-interface-v2.preview.emergentagent.com")
